...
class Info:
    ...
    def title():
        ...
        while True: os.system(f'title Yazato Generator - Generated: {Info.genned} ^| Solved Captchas: {Info.bypassed} ^| Yazato.xyz')
...
class Menu:
    ...
    Info.Title('Yazato Token Generator - Main Menu')
    Info.cls()
    print(f'\n\t\t\t\t\u001b[38;5;45m╦ ╦┌─┐┌─┐┌─┐┌┬┐┌─┐\n\t\t\t\t\u001b[38;5;51m╚╦╝├─┤┌─┘├─┤ │ │ │\n\t\t\t\t\u001b[38;5;87m ╩ ┴ ┴└─┘┴ ┴ ┴ └─┘{Fore.RESET}\n\n\n')
    proxytype = 'http'
